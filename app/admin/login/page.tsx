  ...
  return (
    <main className="admin-login-page">
      <section className="admin-login-card">
        ...
        {reset && <div className="admin-reset-success" role="status">Password updated. You can sign in now.</div>}
        ...
        <Link className="admin-back-link" href="/admin/recover">Use a recovery code</Link>
